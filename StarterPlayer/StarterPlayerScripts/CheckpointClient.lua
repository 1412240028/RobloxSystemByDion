...
function OnCheckpointReachedRemote(reachedPlayer, checkpointOrder, checkpointPart)
	...
	local totalCheckpoints = 10 -- Hardcode sementara atau...

	-- Atau count dari CollectionService
	local CollectionService = game:GetService("CollectionService")
	totalCheckpoints = #CollectionService:GetTagged(Settings.CHECKPOINT_TAG)
